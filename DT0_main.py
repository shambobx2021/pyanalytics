...
import os
os.listdir('G:/OneDrive/MBA/IIM-C/Academics/CPBA/Analytics/Projects/pyanalytics/data') #change the folder to see what are the file in folder
#dataset
...
#Check the accuracy with classification report and confusion matrix
#Predict on unknown samplel data (for which we don not know the result)
#Visualization
...
tree.plot_tree(decision_tree=clsModel, feature_names=['Var', 'Skew', ' Kur',  'Ent'], class_names=['Original','Fake'], fontsize=12)
#not a good way to draw graphs.. other methods to be experimented
tree.plot_tree(decision_tree=clsModel, max_depth=2, feature_names=['Var', 'Skew', ' Kur',  'Ent'], class_names=['Original','Fake'], fontsize=12)
